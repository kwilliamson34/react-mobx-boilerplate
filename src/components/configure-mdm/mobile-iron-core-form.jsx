  ...
  render() {
    ...
    return (
      <div>
        ...
        <TextInput ref={ref => this.store.formFieldRefList.push(ref)} dataObject={this.store.values} id="mi_core_companycode" type="input" labelText="Company Code" required={true} disabled={disabled} errorMessage="Please enter a valid MobileIron Core Company Code." announceError={this.props.announceErrors} charLimit={256} />
